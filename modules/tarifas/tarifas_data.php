...
/** Tarifas do Distrito Federal: [tipo, valor]. */
const TARIFAS_DF = [
...
const FONTE_TARIFAS_DF = 'Com informações da Secretaria de Transporte e Mobilidade — tarifas em vigor a partir de 20/01/2020.';

/** Tarifas intermunicipais (Entorno ↔ DF). `marcador` é opcional. */
const TARIFAS_ENTORNO = [
...
const FONTE_TARIFAS_ENTORNO = 'Tarifas intermunicipais (Entorno ↔ Distrito Federal) vigentes em 2026. Valores sujeitos a alteração pelos órgãos reguladores.';
